...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x122\n" +
	"\aIsAdmin\x12\x12.auth.AdminRequest\x1a\x13.auth.AdminResponseB\rZ\v.gen/go/ssob\x06proto3"
